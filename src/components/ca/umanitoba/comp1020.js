...
class Comp1020 extends Component {
    render() {
        return(
            <div>
                <img src={umanImage} />
                <h1>COMP 1020 - Winter 2020</h1>
                <p>Teaching COMP 1020, M/W/F 10:30 pm - 11:20pm. Attendance is optional,
                but part of your grade is based on in-class testing done via
